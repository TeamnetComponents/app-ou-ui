ouControllers.
    controller('ouTreeViewController', ['$scope', '$location', function ($scope, $location) {
        ...
        $scope.createRootOU = function () {
            ...
            // If args == null, that means a rootNode will be created
            $scope.$emit('newNode', null);
        };
        ...
        $scope.createOU = function (item) {
            ...
            $scope.$emit('newNode', item);
        };

        $scope.editOU = function(item) {
            $scope.$emit('editNode', item);
